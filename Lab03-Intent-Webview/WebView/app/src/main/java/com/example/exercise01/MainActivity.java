...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView userName_text, passWord_text, inFor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inFor = (TextView)findViewById(R.id.loginInfor);
        ...
        LogIn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                String pass_word = passWord_Input.getText().toString().trim();
                ...
                //if password's length is less than 6
                ...
                else if(user_name.equals("user") && pass_word.equals("1234567")){
                    ...
                    Toast.makeText(context, "Wrong Login Infor, try user - 1234567",Toast.LENGTH_SHORT).show();
                    userName_Input.requestFocus();
                }
            }
